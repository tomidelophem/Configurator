...
// Configurator script v0.6
	var nextElement = function (currentQuestion)
	{
		...
		switch (sessionStorage.chain){
			...
			case "Wifi.Centrally.Central_Heating.Suitable_Fuel.OnOff": { solution("NES", null); solution("NET", null); solution("HRO", null); break; };
			case "Wifi.Centrally.Central_Heating.Electrical_Fuel": { solution("NO", null); break; };
			case "Wifi.Centrally.City_Heating.With_Thermostat": { solution("NES", null); solution("NET", null); solution("HRO", null); break; };
...
//				alert(sessionStorage.chain);
	...
	setCurrentQuestion = function (currentQuestion) {
		var currentQuestionElement = $('#' + currentQuestion),
			...
			$('#' + questionContainer).nextAll()
				...
				.fadeOut();
			$("#NO, #HRM, #NET, #SWAP, #HEO, #HEM, #HTRV, #4P, #HEV").hide();
	},
	...
	returnProductLink = function (ref) {
		switch(ref){
			case "NES": { val = "https://www.50five.com/shop/product/130"; break;};
			case "HRO": { val = "https://www.50five.com/shop/product/62"; break;};			
			case "HRM": { val = "https://www.50five.com/shop/product/61"; break;};
			case "NET": { val = "https://www.50five.com/shop/product/91"; break;};
			case "HEO": { val = "https://www.50five.com/shop/product/10"; break;};
			case "HEM": { val = "https://www.50five.com/shop/product/10"; break;};
			case "HTRV": { val = "https://www.50five.com/shop/product/64"; break;};
			case "4P": { val = "https://www.50five.com/shop/product/63"; break;};
