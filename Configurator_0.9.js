...
// Configurator script v0.6
	var nextElement = function (currentQuestion)
	{
		...
		switch (sessionStorage.chain){
			case "No_Wifi.Independent_Boiler.Q7A.Q7B": { solution("SB2", "SP"); break; };
			case "No_Wifi.Control_Boiler.Central_Heating.Suitable_Fuel.OnOff.Q7A.Q7B": {solution("SA2", "SP"); break; };
			...
			case "No_Wifi.Control_Boiler.City_Heating.With_Thermostat.Q7A.Q7B": { solution("SA2", "SP"); break; };
			case "No_Wifi.Control_Boiler.City_Heating.Without_Thermostat": { solution("NO", null); break; };
			case "Wifi.Centrally.Central_Heating.Suitable_Fuel.OpenTherm": { solution("NES", null); solution("HRM", null); break; };
			case "Wifi.Centrally.Central_Heating.Suitable_Fuel.OnOff": { solution("NES", null); solution("HRO", null); solution("NET", null); solution("S500", null); break; };
			case "Wifi.Centrally.Central_Heating.Electrical_Fuel": { solution("NO", null); break; };
			case "Wifi.Centrally.City_Heating.With_Thermostat": { solution("NES", null); solution("HRO", null); solution("NET", null); solution("S500"); break; };
			...
			case "Wifi.Decentrally.Radiators.Valves_Suitable.Independent_Boiler.Distant_Control.Q7A.Q7B": { solution("SB1", "SP"); break; };
			case "Wifi.Decentrally.Radiators.Valves_Suitable.Independent_Boiler.Local_Control.Q7A.Q7B": { solution("SB2", "SP"); break; };
			case "Wifi.Decentrally.Radiators.Valves_Suitable.Control_Boiler.Central_Heating.Suitable_Fuel.OnOff.Local_Control.Q7A.Q7B": { solution("SA2", "SP"); break; };
			case "Wifi.Decentrally.Radiators.Valves_Suitable.Control_Boiler.Central_Heating.Suitable_Fuel.OnOff.Distant_Control.Q7A.Q7B": { solution("SA1", "SP"); solution("HEO", "HP"); break; };
			case "Wifi.Decentrally.Radiators.Valves_Suitable.Control_Boiler.Central_Heating.Suitable_Fuel.OpenTherm.Q7A.Q7B": { solution("HEM", "HP"); break; };
			case "Wifi.Decentrally.Radiators.Valves_Suitable.Control_Boiler.Central_Heating.Electrical_Fuel": { solution("NO", null); break; };
			case "Wifi.Decentrally.Radiators.Valves_Suitable.Control_Boiler.City_Heating.Without_Thermostat": { solution("NO", null); break; };
			case "Wifi.Decentrally.Radiators.Valves_Suitable.Control_Boiler.City_Heating.With_Thermostat.Local_Control.Q7A.Q7B": { solution("SA2", "SP"); break; };
			case "Wifi.Decentrally.Radiators.Valves_Suitable.Control_Boiler.City_Heating.With_Thermostat.Distant_Control.Q7A.Q7B": { solution("SA1", "SP"); solution("HEO", "SP"); break; };
			case "Wifi.Decentrally.Underfloor_Heating": { solution("SWAP", null); break; };
			case "No_Wifi": { question("Q4"); break; };
			...
			case "Wifi.Decentrally.Radiators.Valves_Suitable.Independent_Boiler": { question("Q6"); break; };
			case "Wifi.Decentrally.Radiators.Valves_Suitable.Independent_Boiler.Distant_Control": { question("Q7"); break; };
			case "Wifi.Decentrally.Radiators.Valves_Suitable.Independent_Boiler.Local_Control": { question("Q7"); break; };
			case "Wifi.Decentrally.Radiators.Valves_Suitable.Control_Boiler": { question("Q5A"); break; };
			case "Wifi.Decentrally.Radiators.Valves_Suitable.Control_Boiler.Central_Heating": { question("Q5C"); break; };
			case "Wifi.Decentrally.Radiators.Valves_Suitable.Control_Boiler.Central_Heating.Suitable_Fuel": { question("Q5D"); break; };
			case "Wifi.Decentrally.Radiators.Valves_Suitable.Control_Boiler.Central_Heating.Suitable_Fuel.OnOff": { question("Q6"); break; };
			case "Wifi.Decentrally.Radiators.Valves_Suitable.Control_Boiler.Central_Heating.Suitable_Fuel.OnOff.Distant_Control": { question("Q7"); break; };
			case "Wifi.Decentrally.Radiators.Valves_Suitable.Control_Boiler.Central_Heating.Suitable_Fuel.OnOff.Local_Control": { question("Q7"); break; };
			case "Wifi.Decentrally.Radiators.Valves_Suitable.Control_Boiler.Central_Heating.Suitable_Fuel.OpenTherm": { question("Q7"); break; };
			case "Wifi.Decentrally.Radiators.Valves_Suitable.Control_Boiler.City_Heating": { question("Q5B"); break; };
			case "Wifi.Decentrally.Radiators.Valves_Suitable.Control_Boiler.City_Heating.With_Thermostat": { question("Q6"); break; };
			case "Wifi.Decentrally.Radiators.Valves_Suitable.Control_Boiler.City_Heating.With_Thermostat.Distant_Control": { question("Q7"); break; };
			case "Wifi.Decentrally.Radiators.Valves_Suitable.Control_Boiler.City_Heating.With_Thermostat.Local_Control": { question("Q7"); break; };
			...
			default: {
				...
				//var indexPreviousAnswer = sessionStorage.chain.search(
				// cut chain
				// add last bit
				// Set Current Question
				// nextElement				
				
				// Escape case in case of global bug or missing option ==> BUG handling to be reviewed
				//tempTextChain = sessionStorage.chain;
				//sessionStorage.chain = sessionStorage.chain + ".___BUG___";
				//postToGoogle();
				//sessionStorage.chain = tempTextChain;
				
//				var lastChainElement = sessionStorage.chain.slice(sessionStorage.chain.lastIndexOf('.'));
//				cutSessionStorageChain();
//				cutSessionStorageChain();
//				sessionStorage.chain = sessionStorage.chain + lastChainElement;
//				nextElement(currentQuestion);
			break;}
		};
	},
	...
	setCurrentQuestion = function (currentQuestion) {
		var currentQuestionElement = $('#' + currentQuestion),
			...
			$('#' + questionContainer).nextAll()
				...
				.fadeOut();
			$("#NES, #SB2, #SA2, #NO, #HRM, #HRO, #NET, #S500, #SWAP, #SB1, #SA1, #HEO, #HEM, #HTRV, #STRV, #STH, #4P, #SiT600, #HEV").hide();
	},
	...
	returnProductLink = function (ref) {
		switch(ref){
			case "SB2": { val = "https://www.50five.com/shop/product/salus-it600-kamer-verwarming-79"; break;};
			case "SA2": { val = "https://www.50five.com/shop/product/salus-it600-cv-pakket-84"; break;};
			case "HRM": { val = "https://www.50five.com/shop/product/honeywell-round-mod-thermostaat-130"; break;};
			case "HRO": { val = "https://www.50five.com/shop/product/honeywell-round-onoff-thermostaat-131"; break;};
			case "NET": { val = "https://www.50five.com/shop/product/netatmo-thermostaat-90"; break;};
			case "S500": { val = "https://www.50five.com/shop/product/salus-it500-internet-thermostaat-215"; break;}; //87
			case "SB1": { val = "https://www.50five.com/shop/product/salus-it600-internet-pakket-85"; break;};
			case "SA1": { val = "https://www.50five.com/shop/product/salus-it600-internet-cv-pakket-80"; break;};
			case "HEO": { val = "https://www.50five.com/shop/product/honeywell-evohome-pakket-on-off-128"; break;};
			case "HEM": { val = "https://www.50five.com/shop/product/honeywell-evohome-pakket-mod-127"; break;};
			case "HTRV": { val = "https://www.50five.com/shop/product/honeywell-radiatorregelaar-hr92we-129"; break;};
			case "STRV": { val = "https://www.50five.com/shop/product/salus-it600-thermostatische-kraan-83"; break;};
			case "STH": { val = "https://www.50five.com/shop/product/salus-it600-extra-kamer-pakket-88"; break;};
			case "4P": { val = "https://www.50five.com/shop/product/4-pack-honeywell-radiatorregelaar-168"; break;};
			case "NES": { val = "https://www.50five.com/shop/product/335"; break;};
			default: { val = "https://www.50five.com/shop/category/verwarming-2"; break;};
		};
		return val;
	},
