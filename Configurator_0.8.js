...
// Configurator script v0.6
	var nextElement = function (currentQuestion)
	{
		...
		switch (sessionStorage.chain){
			...
			case "Wifi.Centrally.Central_Heating.Suitable_Fuel.OpenTherm": { solution("HRM", null); break; };
			case "Wifi.Centrally.Central_Heating.Suitable_Fuel.OnOff": { solution("HRO", null); solution("NET", null); solution("S500", null); break; };
			case "Wifi.Centrally.Central_Heating.Electrical_Fuel": { solution("NO", null); break; };
			case "Wifi.Centrally.City_Heating.With_Thermostat": { solution("HRO", null); solution("NET", null); solution("S500"); break; };
